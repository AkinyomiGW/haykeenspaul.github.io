$(document).ready(function() {
  ...
  var modalText = {
    ...
    CryptoInvestment: {
      ...
      tag: 'cryptogalor | Focused trading and investments.',
      detail:
        'We believe that everybody ought to have access to the financial markets, so we have constructed future conglomerate starting from the earliest stage to make contributing receptive and reasonable for newcomers and specialists alike.',
      link: 'https://cgalor.com/'
    },
    newrelic: {
      title: 'NewRelic.com',
